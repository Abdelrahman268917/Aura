...
import {
  ...
  Sparkles, ArrowUpRight, Menu, X, Play
} from 'lucide-react';
...
const content = {
  en: {
    ...
    loader: {
      tagline: 'Turning Chaos Into Systems',
    },
    hero: {
      badge: 'Business Acceleration Studio',
      title1: 'Build Smartly.',
      title2: 'Work Faster.',
      title3: 'Turn Your Business',
      title4: 'Into a System.',
      description: 'We don\'t just sell tools or AI — we start by understanding how your company actually works, then design an operational layer that makes execution natural, improvement continuous, and growth scalable.',
      cta1: 'Start Your Free Audit',
    ...
    why: {
      ...
      problems: [
        { icon: 'scatter', title: 'Scattered Work', desc: 'Conversations in scattered channels and tables — 30% of team time lost' },
      ...
      layers: [
        {
          ...
          impact: 'Save 15-30% of operational costs within 30 days',
          icon: 'search',
        },
        {
          num: '02',
          ...
          impact: 'Speed up delivery 30-50% and reduce re-work by 40%',
          icon: 'flow',
        },
        {
          num: '03',
          ...
          impact: 'Save 10-20 weekly hours per team member from manual work',
          icon: 'build',
        },
        {
          num: '04',
          ...
          impact: 'Save 40-60% of repetitive task time = full employee cost/month',
          icon: 'bot',
        },
        {
          num: '05',
          ...
          solution: '30+ successful AI content ideas + daily evaluation + 90-day hook analysis + 20+ competitor analysis',
          kpis: ['Follower growth', 'Monthly recurring reach', 'Conversion rate', 'Cost per lead'],
          impact: 'Increase reach 20-40% within 90 days of strategic execution',
          icon: 'trend',
        },
        {
          num: '06',
          ...
          impact: 'Reach first revenue 50% faster compared to unstructured launch',
          icon: 'rocket',
        },
      ],
      who: [
    ...
    process: {
      ...
      questions: {
        title: 'Quality Filter: How Do We Ensure Effective Implementation?',
        items: [
          'What problem does this solve?',
          'What will the team use daily?',
          'How do we know the system is working?',
          'What are the work stages that will become easier?',
        ],
      },
      deliverables: {
        basic: ['Complete process map of how the company works', 'Clear and documented workflow for each main process', 'Prioritized options for immediate execution', 'Customized internal follow-up systems and tools', 'AI and automation paths'],
        additional: ['Comprehensive documentation for the system', 'Ready-made policy for usage and iteration', 'ROI report with specific numbers', 'Recommendations for next steps and expansion', 'Training and delivery session for the team'],
      },
    },
    packages: {
      badge: 'Packages',
    ...
    differentiators: {
      badge: 'Why Us',
      title: 'Factors That Make Our Offer Irresistible',
      items: [
        { icon: 'zap', title: 'Instant Visual Result', desc: '15-minute free audit → instant report with top 3 options. No waiting.', quote: '"The one who knows a problem acts fast" — The Impact' },
        { icon: 'shield', title: 'Guaranteed Results', desc: 'We work with you for up to 90 days until ROI is achieved. Every risk eliminated.', quote: '"Either I win or I learn" — The Impact' },
        { icon: 'target', title: 'Quick Specialization, No Lock-in', desc: 'Customized plan built on your company\'s actual data — not a generic template.', quote: '"This is customized for me, not for everyone" — The Impact' },
        { icon: 'credit', title: 'Flexible Payment', desc: 'Monthly or quarterly payment proportionate to your company size. No financial pressure.', quote: '"I can start now without financial pressure" — The Impact' },
        { icon: 'book', title: 'Free Educational Content', desc: '10 gaps your company may have + "Free Guide" + educational videos on how to analyze.', quote: '"An expert wants to help me do it" — The Impact' },
        { icon: 'chart', title: 'Results Trusted with Numbers', desc: 'Real success stories with specific numbers: "40% delivery speed increase within 30 days".', quote: '"Others succeed like us, we\'ll succeed too" — The Impact' },
        { icon: 'refresh', title: 'First Project Free, No Commitment', desc: 'Clear scope and hours with no long-term commitment. 3 monthly subscription options for maintenance.', quote: '"I understand it immediately, and you\'ll get paid for it" — The Impact' },
        { icon: 'sparkle', title: 'Simple Yet Sophisticated Display', desc: 'Clear packages with defined stages and hours — no ambiguity or complexity.', quote: '"Make it simple for me" — The Impact' },
      ],
    },
    examples: {
      badge: 'Examples',
      ...
      items: [
        {
          ...
          result: ['Complete visual production pipeline', 'Every project tracked from brief to delivery', '45% reduction in delays', 'No lost requests or modifications'],
        },
        {
          icon: 'bot',
          title: 'Studio with AI',
          challenge: 'Ideas, orders, events, scheduling, publishing — everything connects manually',
          result: ['Fully managed content system', 'AI generates daily ideas', '60% reduction in production time', 'Systematic and interactive publishing evaluation'],
        },
        {
          icon: 'health',
          title: 'Academic / Medical',
          challenge: 'Appointments, lectures, students, tables, materials, expenses',
          result: ['Complete administrative operations hub', 'Automated registration, scheduling, and reminders', 'Attendance tracking and student progress', '50% reduction in admin time'],
        },
        {
          icon: 'inbox',
          title: 'Operations & Reception',
          challenge: 'New inquiries, scattered follow-up, disorganized tracking — lost revenue',
          result: ['Scalable reception pipeline', 'Automated follow-up with CRM integration', '35% increase in conversion rate', 'No potential client falls through the cracks'],
        },
      ],
    },
    tools: {
      ...
      subtitle: 'We choose the right tools for each company — we don\'t impose a technology.',
      categories: [
        {
          name: 'Automation',
          tools: [
    ...
    contact: {
      ...
      subtitle: 'Start with a free 15-minute audit — identify the top 3 improvements in your company.',
      email: 'amirelshazly66@gmail.com',
      phone: '+20 102 924 0066',
      location: 'Egypt / Available remotely worldwide',
      questions: [
        ...
        'What result will you achieve in the first 30-60 days with the studio?',
      ],
      cta: 'Book Free Audit',
    },
    footer: {
  ...
  ar: {
    ...
    loader: {
      tagline: 'نحوّل الفوضى إلى أنظمة',
    },
    hero: {
      badge: 'استديو تسريع وتيرة الأعمال',
      title1: 'نبني بذكاء.',
      title2: 'نعمل أسرع.',
      title3: 'حوّل عملك',
      title4: 'إلى نظام.',
      description: 'نبدأ بفهم طريقة عمل شركتك الفعلية، ثم نصمم طبقة تشغيلية تجعل التنفيذ طبيعياً، والتحسين مستمراً، والنمو قابلاً للتوسع.',
      cta1: 'ابدأ تدقيقك المجاني',
      cta2: 'شاهد كيف نعمل',
      stat1: '٣٠-٥٠٪',
      stat1Label: 'توفير في التكاليف',
      stat2: '٤٠-٦٠٪',
      stat2Label: 'توفير في الوقت',
      stat3: '٩٠ يوم',
      stat3Label: 'ضمان العائد',
    },
    why: {
      badge: 'المشكلة',
      ...
      problems: [
        { icon: 'scatter', title: 'عمل متفرق', desc: 'محادثات في قنوات وجداول متفرقة — ٣٠٪ من وقت الفريق يضيع' },
      ...
      layers: [
        {
          ...
          impact: 'وفّر ١٥-٣٠٪ من التكاليف التشغيلية خلال ٣٠ يوم',
          icon: 'search',
        },
        {
          num: '٠٢',
          ...
          impact: 'سرّع التسليم ٣٠-٥٠٪ وقلل إعادة العمل بنسبة ٤٠٪',
          icon: 'flow',
        },
        {
          num: '٠٣',
          ...
          impact: 'وفّر ١٠-٢٠ ساعة أسبوعياً لكل فرد من العمل اليدوي',
          icon: 'build',
        },
        {
          num: '٠٤',
          ...
          impact: 'وفّر ٤٠-٦٠٪ من وقت المهام المتكررة = تكلفة موظف كامل/شهر',
          icon: 'bot',
        },
        {
          num: '٠٥',
          ...
          solution: '٣٠+ فكرة محتوى ناجحة بـ AI + تقييم يومي + تحليل hook لـ ٩٠ يوم + تحليل ٢٠+ منافس',
          kpis: ['نمو المتابعين', 'الوصول المتكرر الشهري', 'معدل التحويل', 'تكلفة العميل المحتمل'],
          impact: 'زد الوصول ٢٠-٤٠٪ خلال ٩٠ يوم من التنفيذ الاستراتيجي',
          icon: 'trend',
        },
        {
          num: '٠٦',
          ...
          impact: 'الوصول لأول إيراد أسرع بنسبة ٥٠٪ مقارنة بالإطلاق غير المنظم',
          icon: 'rocket',
        },
      ],
      who: [
    ...
    process: {
      ...
      questions: {
        title: 'فلتر الجودة: كيف نضمن تنفيذاً فعالاً؟',
        items: [
          'ما المشكلة التي يحلها هذا؟',
          'ماذا سيستخدم الفريق يومياً؟',
          'كيف نعرف أن النظام يعمل؟',
          'ما مراحل العمل التي ستسهل؟',
        ],
      },
      deliverables: {
        basic: ['خريطة عملية كاملة لكيفية عمل الشركة', 'مسار عمل واضح وموثق لكل عملية رئيسية', 'خيارات أولويات للتنفيذ الفوري', 'أنظمة وأدوات متابعة داخلية مخصصة', 'مسارات الذكاء الاصطناعي والأتمتة'],
        additional: ['توثيق شامل للنظام', 'سياسة جاهزة للاستخدام والتكرار', 'تقرير ROI بأرقام محددة', 'توصيات للخطوات التالية والتوسع', 'تدريب وجلسة تسليم للفريق'],
      },
    },
    packages: {
      badge: 'الباقات',
      ...
      full: {
        ...
        features: [
          ...
          'خارطة توسع مستقبلية',
          'اختياري: جلسات متابعة شهرية',
        ],
        cta: 'ابدأ النظام الكامل',
      },
      guide: {
    ...
    differentiators: {
      badge: 'لماذا نحن',
      title: 'عوامل تجعل عرضنا لا يُقاوم',
      items: [
        { icon: 'zap', title: 'نتيجة بصرية فورية', desc: 'تدقيق مجاني ١٥ دقيقة → تقرير فوري بأهم ٣ خيارات. بدون انتظار.', quote: '"الشخص الذي يعرف مشكلة يتصرف بسرعة" — الأثر' },
        { icon: 'shield', title: 'نتائج مضمونة', desc: 'نعمل معك لمدة تصل إلى ٩٠ يوماً حتى تتحقق ROI. كل مخاطرة تُزال.', quote: '"إما أن أفوز أو أتعلم" — الأثر' },
        { icon: 'target', title: 'تخصيص سريع بلا قفل', desc: 'خطة مخصصة مبنية على بيانات شركتك الفعلية — لا قالب عام.', quote: '"هذا مخصص لي، ليس للجميع" — الأثر' },
        { icon: 'credit', title: 'دفع مرن', desc: 'دفع شهري أو ربع سنوي متناسب مع حجم شركتك. بدون ضغط مالي.', quote: '"أستطيع البدء الآن بدون ضغط مالي" — الأثر' },
        { icon: 'book', title: 'محتوى تعليمي مجاني', desc: '١٠ فجوات قد تكون في شركتك + "دليل مجاني" + فيديوهات تعليمية.', quote: '"خبير يريد مساعدتي" — الأثر' },
        { icon: 'chart', title: 'نتائج موثوقة بأرقام', desc: 'قصص نجاح حقيقية بأرقام محددة: "زيادة سرعة التسليم ٤٠٪ خلال ٣٠ يوم".', quote: '"آخرون نجحوا مثلنا، سننجح أيضاً" — الأثر' },
        { icon: 'refresh', title: 'أول مشروع مجاني بلا التزام', desc: 'نطاق وساعات محددة بدون التزام طويل الأمد. ٣ خيارات اشتراك شهري للصيانة.', quote: '"أفهمه فوراً، وستحصلون على أجركم" — الأثر' },
        { icon: 'sparkle', title: 'عرض بسيط ومتقن', desc: 'باقات واضحة بمراحل وساعات محددة — لا غموض أو تعقيد.', quote: '"اجعله بسيطاً لي" — الأثر' },
      ],
    },
    examples: {
      badge: 'أمثلة',
      ...
      items: [
        {
          ...
          result: ['خط إنتاج بصري كامل', 'كل مشروع يتتبع من البريف للتسليم', 'تقليل التأخير ٤٥٪', 'لا طلبات أو تعديلات ضائعة'],
        },
        {
          icon: 'bot',
          title: 'استديو مع AI',
          challenge: 'أفكار، طلبات، أحداث، جدولة، نشر — كل شيء يربط يدوياً',
          result: ['نظام محتوى مدار بالكامل', 'AI يولد أفكار يومية', 'تقليل وقت الإنتاج ٦٠٪', 'تقييم نشر تفاعلي ومنظم'],
        },
        {
          icon: 'health',
          title: 'أكاديمي / طبي',
          challenge: 'مواعيد، محاضرات، طلاب، جداول، مواد، مصاريف',
          result: ['مركز عمليات إدارية كامل', 'أتمتة التسجيل والجدولة والتذكير', 'تتبع الحضور وتقدم الطلاب', 'تقليل وقت الإدارة ٥٠٪'],
        },
        {
          icon: 'inbox',
          title: 'عمليات واستقبال',
          challenge: 'استفسارات جديدة، متابعة متفرقة، تتبع غير منظم — إيرادات ضائعة',
          result: ['مسار استقبال قابل للتوسع', 'متابعة مؤتمتة مع تكامل CRM', 'زيادة معدل التحويل ٣٥٪', 'لا عميل محتمل يسقط من الشبكة'],
        },
      ],
    },
    tools: {
      ...
      subtitle: 'نختار الأدوات المناسبة لكل شركة — لا نفرض تقنية.',
      categories: [
        {
          name: 'الأتمتة',
          tools: [
    ...
    contact: {
      ...
      subtitle: 'ابدأ بتدقيق مجاني ١٥ دقيقة — حدد أهم ٣ تحسينات في شركتك.',
      email: 'amirelshazly66@gmail.com',
      phone: '+20 102 924 0066',
      location: 'مصر / متاح عن بُعد في جميع أنحاء العالم',
      questions: [
        'كيف يعمل سير عملك الحالي حتى التسليم النهائي؟',
        'أين يظهر التأخير أو إعادة العمل أو الفوضى أكثر في عملك؟',
        'ما النتيجة التي ستحققها في أول ٣٠-٦٠ يوم مع الاستديو؟',
      ],
      cta: 'احجز تدقيق مجاني',
    },
    footer: {
      tagline: 'استديو تسريع وتيرة الأعمال',
...
function Navigation({ lang, setLang, scrolled }: { lang: 'en' | 'ar'; setLang: (l: 'en' | 'ar') => void; scrolled: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        <a href="#home" className="flex items-center justify-center px-4 h-12 group">
...
function HeroSection({ lang }: { lang: 'en' | 'ar' }) {
  ...
  return (
    <section id="home" ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden py-20 lg:py-0">
      {/* Background */}
      <motion.div style={{ y }} className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0" style={{
          background: 'radial-gradient(ellipse at 20% 50%, rgba(242,169,0,0.08) 0%, transparent 50%), radial-gradient(ellipse at 80% 20%, rgba(139,92,246,0.12) 0%, transparent 50%)',
        }} />
      </motion.div>
      ...
      <motion.div style={{ opacity }} className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className={`grid lg:grid-cols-12 gap-12 items-center text-center ${isRtl ? 'lg:text-right' : 'lg:text-left'}`}>
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-6 leading-[1.15] tracking-tight"
              style={{ color: '#fff' }}
            >
            ...
            <motion.p
              ...
              className="text-base md:text-lg mb-8 leading-relaxed max-w-2xl text-left"
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-4 items-center mb-12 w-full sm:w-auto"
            >
              <a
                href="#contact"
            ...
            <motion.div
              ...
              className="grid grid-cols-3 gap-8 w-full max-w-md pt-6 border-t border-purple-500/10"
            >
              {[
                ...
                <div key={i} className={`text-center ${isRtl ? 'lg:text-right' : 'lg:text-left'}`}>
                  <div className="text-xl md:text-2xl font-bold text-gold-gradient">{stat.val}</div>
                  <div className="text-xs mt-1 font-medium" style={{ color: '#B5AEC4' }}>{stat.label}</div>
                </div>
              ))}
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
            <motion.div
              ...
              className="relative group w-full max-w-md aspect-square rounded-2xl p-2"
              style={{
...
function WhySection({ lang }: { lang: 'en' | 'ar' }) {
  ...
  return (
    <AnimatedSection id="why" className="py-24 md:py-32 px-6 relative overflow-hidden" >
...
function ServicesSection({ lang }: { lang: 'en' | 'ar' }) {
  ...
  return (
    <AnimatedSection id="services" className="py-24 md:py-32 px-6 relative overflow-hidden" style={{ background: 'transparent' }}>
...
function ProcessSection({ lang }: { lang: 'en' | 'ar' }) {
  ...
  return (
    <AnimatedSection id="process" className="py-24 md:py-32 px-6 relative overflow-hidden" style={{ background: 'transparent' }}>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-8 rounded-2xl" style={{ background: 'rgba(242,169,0,0.04)', border: '1px solid rgba(242,169,0,0.20)', backdropFilter: 'blur(10px)' }}>
            <h3 className="font-bold text-lg mb-6" style={{ color: '#F2A900' }}>{t.questions.title}</h3>
            <ul className="space-y-4">
              {t.questions.items.map((q, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="mt-0.5 shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold" style={{ background: '#F2A900', color: '#090416' }}>{i + 1}</span>
                  <span className="text-sm font-medium" style={{ color: 'rgba(255,255,255,0.8)' }} dir={isRtl ? 'rtl' : 'ltr'}>{q}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-6 rounded-2xl" style={{ background: 'rgba(20,9,38,0.4)', border: '1px solid rgba(139,92,246,0.12)' }}>
              <h4 className="font-bold text-sm mb-3" style={{ color: '#FFD666' }}>
                {lang === 'en' ? 'Core Deliverables' : 'المخرجات الأساسية'}
              </h4>
              <ul className="space-y-2">
                {t.deliverables.basic.map((d, i) => (
                  <li key={i} className="flex items-start gap-2 text-xs" style={{ color: '#B5AEC4' }}>
                    <Check size={12} className="shrink-0 mt-0.5" style={{ color: '#F2A900' }} />
                    <span dir={isRtl ? 'rtl' : 'ltr'}>{d}</span>
                  </li>
                ))}
              </ul>
            </div>
            <div className="p-6 rounded-2xl" style={{ background: 'rgba(20,9,38,0.4)', border: '1px solid rgba(139,92,246,0.12)' }}>
              <h4 className="font-bold text-sm mb-3" style={{ color: '#FFD666' }}>
                {lang === 'en' ? 'Additional Deliverables' : 'مخرجات إضافية'}
              </h4>
              <ul className="space-y-2">
                {t.deliverables.additional.map((d, i) => (
                  <li key={i} className="flex items-start gap-2 text-xs" style={{ color: '#B5AEC4' }}>
                    <Check size={12} className="shrink-0 mt-0.5" style={{ color: '#F2A900' }} />
                    <span dir={isRtl ? 'rtl' : 'ltr'}>{d}</span>
                  </li>
...
function PackagesSection({ lang }: { lang: 'en' | 'ar' }) {
  ...
  return (
    <AnimatedSection id="packages" className="py-24 md:py-32 px-6 relative overflow-hidden" style={{ background: 'transparent' }}>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h3 className="text-xl font-bold mb-6" style={{ color: '#fff' }}>{t.guide.title}</h3>
          <div className="grid md:grid-cols-2 gap-4 max-h-[28rem] overflow-y-auto pr-2">
...
function DifferentiatorsSection({ lang }: { lang: 'en' | 'ar' }) {
  ...
  return (
    <AnimatedSection id="why" className="py-24 md:py-32 px-6 relative overflow-hidden" style={{ background: 'transparent' }}>
      <div className="absolute inset-0 bg-radial-gradient from-purple-900/5 via-transparent to-transparent -z-10" />
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase mb-6" style={{ background: 'rgba(139,92,246,0.1)', color: '#A78BFA', border: '1px solid rgba(139,92,246,0.15)' }}>
...
function ExamplesSection({ lang }: { lang: 'en' | 'ar' }) {
  ...
  return (
    <AnimatedSection className="py-24 md:py-32 px-6 relative overflow-hidden" style={{ background: 'transparent' }}>
      <div className="absolute inset-0 bg-radial-gradient from-purple-900/5 via-transparent to-transparent -z-10" />
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase mb-6" style={{ background: 'rgba(139,92,246,0.1)', color: '#A78BFA', border: '1px solid rgba(139,92,246,0.15)' }}>
    ...
    <AnimatedSection className="py-24 md:py-32 px-6 relative overflow-hidden" style={{ background: 'transparent' }}>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          {/* Left: Tools Grid */}
          <div className="lg:col-span-7 grid sm:grid-cols-3 gap-6 order-2 lg:order-1">
            {t.categories.map((cat, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className={`p-6 rounded-2xl ${isRtl ? 'text-right' : 'text-left'}`}
                style={{
                  background: 'rgba(20,9,38,0.4)',
                  border: '1px solid rgba(139,92,246,0.15)',
                  backdropFilter: 'blur(10px)',
          ...
          <div className="lg:col-span-5 order-1 lg:order-2 flex justify-center">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative group w-full max-w-sm aspect-square rounded-2xl p-2"
              style={{
                background: 'linear-gradient(135deg, rgba(139,92,246,0.1) 0%, rgba(242,169,0,0.02) 100%)',
                border: '1px solid rgba(139,92,246,0.15)',
                boxShadow: '0 10px 30px rgba(0,0,0,0.3)',
              }}
            >
              <div className="absolute inset-0 rounded-2xl bg-purple-500/5 filter blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500 -z-10" />
              <div className="relative w-full h-full rounded-xl overflow-hidden border border-white/5 bg-[#090416]/50">
                <img
                  src="/workflow_nodes.png"
                  alt="AURA System Automation Nodes"
                  className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                />
              </div>
            </motion.div>
...
function ContactSection({ lang }: { lang: 'en' | 'ar' }) {
  ...
  return (
    <AnimatedSection id="contact" className="py-24 md:py-32 px-6 relative overflow-hidden" style={{ background: 'transparent' }}>
      <div className="absolute inset-0 bg-radial-gradient from-purple-900/5 via-transparent to-transparent -z-10" />
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className={`p-8 rounded-3xl mb-8 ${isRtl ? 'text-right' : 'text-left'}`} style={{
          ...
          <h3 className="font-bold text-lg mb-6 text-gold-gradient text-center">
            {lang === 'en' ? 'Questions We Love to Answer' : 'أسئلة نحب أن نطرحها'}
          </h3>
        ...
        <a
          href={`mailto:${t.email}?subject=${lang === 'en' ? 'Free Audit Request' : 'طلب تدقيق مجاني'}`}
...
function Footer({ lang }: { lang: 'en' | 'ar' }) {
  ...
  return (
    <footer className="py-12 px-6 text-center" style={{ background: '#090416', borderTop: '1px solid rgba(139,92,246,0.1)' }}>
